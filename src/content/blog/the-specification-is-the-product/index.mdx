...
I built [this website](https://github.com/tskovlund/skovlund.dev) without writing a single line of code. I know — you've heard that sentence before. It's becoming a cliché. But stop for a second and think about how insane the underlying fact still is. [Claude Code](https://github.com/anthropics/claude-code) agents wrote every line — I never opened nvim once. Claude Code celebrated its first birthday last week. The tool that built this entire site didn't exist thirteen months ago. I described what I wanted, reviewed what the agents produced, rejected plenty, and iterated until it matched my taste. The site has twelve color schemes (a bit excessive, sure, but try it out below — it's a buffet), perfect accessibility scores, and a hidden trombone you can play if you find it. All specified, nothing typed.
