...
- **AI assistant** — [Eliza](/projects/eliza), an autonomous AI assistant built on [ZeroClaw](https://github.com/zeroclaw-labs/zeroclaw), connected to [Telegram](https://telegram.org). Built from source via a Nix flake input. Still figuring out how much autonomy to give her — as the screenshot below suggests, the NixOS sandbox keeps things interesting.
