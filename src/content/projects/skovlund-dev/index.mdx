...
Page navigations use Astro's [View Transitions API](https://docs.astro.build/en/guides/view-transitions/) for a seamless, app-like feel. The header and footer persist across navigations — they never re-render. Content fades in with a subtle 300ms transition.
